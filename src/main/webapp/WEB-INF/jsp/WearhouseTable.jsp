...
<!-- 							<a href="PurchaseTable"><input type="button" -->
<!-- 								value="New Purchase Item" class="btn btn-secondary waves-effect" /></a> -->
						</div>
					</div>
<!--   ============end page title========================== -->
...
<!-- 									<h5 class="mt-0 header-title">Pending Projects</h5> -->
									<div class="table-rep-plugin">
										<div class="table-responsive mb-0" data-pattern="priority-columns">
											<table id="storeRecordsTable" class="table table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
												<thead>
													<tr>
														<th>#</th>
														<th>Item Code</th>
...
<%-- 													<c:forEach varStatus="loopCounter" items="${storedetails}" --%>
<%-- 														var="storeDetails"> --%>
<!-- 														<tr> -->
<%-- 															<c:set var="count" value="${count + 1}" scope="page" /> --%>
<%-- 															<td><c:out value="${count}"></c:out></td> --%>
<%-- 															<td id="item_code"><c:out value="${storeDetails.itemCode}"></c:out></td> --%>
...
// 				alert(response);
				setStoreTable(response);
			}
		});
	}
	
	
	function setStoreTable(response) {
		
		var tableID = '#storeRecordsTable';
		var count1 = 0;
		console.log(tableID);
		var mytable;
