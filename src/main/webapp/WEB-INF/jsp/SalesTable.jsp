...
<!--    ================start page title================= -->
					<div class="row">
						...
						<div class="col-md-6" align="right">
							<button type="button"
								class="btn btn-outline-secondary inputbutton"
...
<!-- 									<h5 class="mt-0 header-title">Pending Projects</h5> -->
									<div class="table-rep-plugin">
										<div class="table-responsive mb-0" data-pattern="priority-columns">
											<table id="salesRecordsTable" class="display" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
												<thead>
													<tr>
														<th>#</th>
														<th>Item Code</th>
...
function getSalesData(){
	$.ajax({
		...
		success : function(response) {
			setItemTable(response);
		}
	});
}

function setItemTable(response) {
	var tableID = '#salesRecordsTable';
	var count1 = 0;
	console.log(tableID);
	var mytable;
...
//				console.log(val);
// 	var vewButton = '<input type="button" value = "View"  id ="more" class="btn btn-secondary" onclick =\"javascript:window.location.href=\'ViewItemDetails?id='+val.id+'\'; \">' ;
