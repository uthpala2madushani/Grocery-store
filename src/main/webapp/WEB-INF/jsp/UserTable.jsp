...
<!-- 									<h5 class="mt-0 header-title">Pending Projects</h5> -->
									<div class="table-rep-plugin">
										<div class="table-responsive mb-0" data-pattern="priority-columns">
											<table id="userRecordsTable" class="table table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
												<thead>
													<tr>
														<th>#</th>
														<th>Name</th>
...
<%-- 													<c:forEach varStatus="loopCounter" items="${itemList}" --%>
<%-- 														var="itemRecord"> --%>
<!-- 														<tr> -->
<%-- 															<c:set var="count" value="${count + 1}" scope="page" /> --%>
<%-- 															<td><c:out value="${count}"></c:out></td> --%>
<%-- 															<td id="item_code"><c:out value="${itemRecord.itemCode}"></c:out></td> --%>
<%-- 															<td id="item_name"><c:out value="${itemRecord.name}"></c:out></td> --%>
<%-- 															<td id="pu_price"><c:out value="${itemRecord.purchasePrice}"></c:out></td> --%>
<%-- 															<td id="sell_price"><c:out value="${itemRecord.sellingPrice}"></c:out></td> --%>
<%-- 															<td id="sell_price"><c:out value="${itemRecord.status == true? 'Available' : 'Unavailable'}"></c:out></td> --%>

<!-- 															<td><a -->
<%-- 																href="ViewItemDetails?id=${itemRecord.id}"><input --%>
<!-- 																	type="button" value="More" -->
<!-- 																	class="btn btn-outline-secondary inputbutton" /></a></td> -->
																	
<!-- 																<td>	<a -->
<%-- 																href="DeleteItem?id=${itemRecord.id}"><input --%>
<!-- 																	type="button" value="Delete" -->
<!-- 																	class="btn btn-secondary waves-effect" /></a></td> -->
<!-- 														</tr> -->
<%-- 													</c:forEach> --%>
												</tbody>
											</table>
